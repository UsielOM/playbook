...
class Miherencia extends LaunchXStudent {}


const usielXDev = new Miherencia("Usiel", "js", ["elixir", "groovy", "lisp"])
console.log(usielXDev)
console.log(usielXDev.getName) // getter de la clase padre rehusada en la clase hija